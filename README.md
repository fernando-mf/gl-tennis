...
1. Open the project
2. Change the project root to ./src (Actions -> Change project root Cmake). This is needed to resolve the shaders, otherwise you'll have to provide the absolute path.
